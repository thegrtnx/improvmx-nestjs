...
export class ImprovmxService {
	...
	constructor(
		...
		this.apiKey = this.configService.get<string>("IMPROVMX_API_KEY") || "";
	...
	private async axiosRequest(method: string, url: string, data?: any, params?: any) {
		try {
	...
	private httpServiceRequest(method: string, url: string, data?: any, params?: any) {
	...
	// Domain endpoints
	getDomains(params?: { q?: string; is_active?: boolean; limit?: number; page?: number }) {
	...
	updateDomain(domain: string, notification_email?: string, webhook?: string, whitelabel?: string) {
	...
	// Alias endpoints
	getAliases(domain: string, params?: { q?: string; alias?: string; is_active?: boolean; page?: number }) {
	...
	addAliasesBulk(domain: string, aliases: Array<{ alias: string; forward: string }>, behavior: string = "add"): Promise<any> {
